    ...
    <v-container grid-list-md fluid>
      <v-layout wrap>
          ...
          >
            ...
            <template #item="{ item }">
              <tr>
                ...
                <td class="px-0">
                  <v-tooltip left v-if="hasCoproPreProgRight" color="primary">
                    <template #activator="{ on }">
                      <v-btn
                        color="primary"
                        icon
        ...
        <v-flex xs12 class="caption">
          ...
          l'une pour le besoin, l'autre pour la pré programmation.
        </v-flex>
      </v-layout>
    </v-container>
    <copro-pre-prog-dlg
...
<script>
import CoproPreProgDlg from './CoproPreProgDlg'
...
export default {
  ...
  components: { CoproPreProgDlg, DeleteDialog, PreProg },
