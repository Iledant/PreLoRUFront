...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Copro', value: 'CoproName', sortable: true },
  ...
  computed: {
    ...
    items () {
      return this.$store.state.copros.coproReport
    },
    totalBudget () {
  ...
  methods: {
    download () {
      ...
      const columns = [
        ...
        { header: 'Copro', key: 'CoproName', width: 30 },
        {
          header: 'Budget',
          key: 'Budget',
          width: 14,
      ...
      excelExport(formattedReport, columns, 'Preprog copro')
    }
  }
}
</script>
